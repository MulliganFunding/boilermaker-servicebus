...
def verify_storage_started_and_get_result_calls(mock_storage, task: Task, store_call_count: int = 2) -> TaskResult:
    """
    ...
    msg = f"Expected {store_call_count} Received {mock_storage.store_task_result.call_count}"
    assert mock_storage.store_task_result.call_count == store_call_count, msg
    ...
    return started_result, stored_result, others
